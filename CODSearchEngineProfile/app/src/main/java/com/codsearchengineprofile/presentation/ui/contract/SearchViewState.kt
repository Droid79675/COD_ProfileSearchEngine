...
open class SearchViewState {
    ...
    data class Loading @Inject constructor(val username: String, val platform: String) :
        SearchViewState()

    data class Success @Inject constructor(val profileDomainModel: ProfileDomainModel) :
        SearchViewState()
